...
class ProjectReportButton(models.TransientModel):
    _name = 'liderit.wizard.project.report'
    ...
    def print_project_report_pdf(self):
        ...
        return self.env['report'].get_action(record, "liderit_project_report_pdf.liderit_project_report_transition")
    ...
    def print_project_report_xls(self):
        ...
        return {'type': 'ir.actions.report.xml',
                'report_name': 'liderit_project_report_pdf.project_report_xls.xlsx',
                'datas': datas,
                'name': 'Project Report'
                }
