...
#        'tercap_vendedor': fields.boolean('Vendedor'), 
        'tercap_ruta_id': fields.many2one('ruta', 'Ruta comercial'),
...
class stock_picking(osv.osv):
    ...
    _columns = {
        #NOVEDAD 28-6-16: pasan a ser dos tipos de ruta: una comercial y otra de reparto vinculadas por el pedido de venta
        'ruta_id':fields.related('partner_id','tercap_ruta_id',type='many2one',relation='ruta',readonly=True,string='Ruta comercial',store=True),
        #'reparto_id':fields.related('sale_id','reparto_id',type='many2one',relation='ruta',readonly=True,string='Ruta de reparto',store=True),
        'section_id':fields.related('partner_id','section_id',type='many2one',relation='crm.case.section',readonly=True,string='Equipo de Ventas',store=True),
        }
