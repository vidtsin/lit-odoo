...
===========================================================
    ...
    'depends': ['account','account_payment_sale', 'account_invoice_sale_link','product','sale', 'sale_journal', 'sales_team','sale_stock', 'sale_quick_payment', 'sale_three_discounts'],
    'data': [
